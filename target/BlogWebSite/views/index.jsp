...
<head>
    ...
    <!-- font awesome css -->
    <link href="${pageContext.request.contextPath}/css/fontawesome-all.css" type="text/css" rel="stylesheet" media="all" />
    <!-- bootstrap css -->
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img class="card-img-top align-self-center" src="${pageContext.request.contextPath}/images/abt.jpg" alt="Card image cap">
                                    </div>
                                    <div class="col-md-6">
            ...
            <div class="col-lg-6 p-0">
                <img src="${pageContext.request.contextPath}/images/abt.jpg" alt="about-image-agileits" class="img-fluid" />
            </div>
        </div>
    </div>
</section>
        ...
        <div class="w3ls-video-info py-lg-5">
            <div class="container">
                <h1 class="heading1">What separates design from art is that design is meant to be...
                    <br>functional.</h1>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ut risus eget libero finibus facilisis.
...
<section class="news pb-5" id="section6">
    <div class="container">
        ...
        <div class="card-columns">
            ...
            <div class="card">
                <img class="card-img-top" src="${pageContext.request.contextPath}/images/banner1.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title">News title goes here</h5>
                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This
                        content is a little bit longer.</p>
                    ...
                    <div class="modal fade" id="exampleModal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel6" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img class="card-img-top" src="${pageContext.request.contextPath}/images/g11.jpg" alt="Card image cap">
                                    <p class="my-3">This is a longer card with supporting text below as a natural lead-in to additional
                                        content. This content is a little bit longer. There are many variations of passages
                                        of Lorem Ipsum available, but the majority have suffered alteration in some form,
                                        by injected humour, or randomised words which don't look even slightly believable.
