...
<head>
    ...
    <!-- font awesome css -->
    <link href="${pageContext.request.contextPath}/css/fontawesome-all.css" type="text/css" rel="stylesheet"
          media="all"/>
    <!-- bootstrap css -->
...
<div class="banner">
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">J4v4 Code</a>
        ...
        <div class="w3ls-wrapper-content">
            <div class="row pt-lg-3">
                <div class="agileits-s-grid col-lg-4 col-12 mt-5">
                    ...
                    <p> Sun Microsystems mühendislerinden James Gosling tarafından geliştirilmeye başlanmış açık kaynak
                        kodlu, nesneye yönelik, zeminden bağımsız, yüksek verimli,
        ...
        <div class="row">
            <div class="col-lg-6 wthree-abt-info">
                ...
                <p class="my-xl-4 my-lg-3 my-md-4 my-3">
                    Uğur Can GÜLEÇ ve İsa SAYAR Düzce ÜNİVERSİTESİ Bilgisayar Mühendisliği Bölümünde Lisans süresi boyunca birlikte okudular.
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p> Lisans süresi boyunca birlikte birçok proje geliştirdiler.Bunlardan en çok göze çarpanları ise
                                            Tez projesi ve Java ile Kutuphane Otonmasyon projeleri idi.Çünkü bu projeler ile birlikte ne kadar uyumlu  çalıştıklarını gördüler.
                                            Mezun olduktan sonra da Uğur Can GÜLEÇ'in hayali olan J4v4 Code sitesini Java SE ve Java EE teknolojilerini kullanarak bir Web Sitesi geliştirmek
                                            üzere tekrar bir araya geldiler.</p>
                                    </div>
                                </div>
...
<!-- custom js file -->
<script src="${pageContext.request.contextPath}/js/universe.js"></script>
<!-- /custom js file -->
